...
const About = () => {
  return (
    ...
    >
      ...
      <div className="text-center flex flex-col md:flex-row  justify-around pb-10 pt-10 md:px-[15rem] gap-[2.5rem] md:gap-[5rem]">
        <div className="flex flex-col md:items-start gap-1">
          <p className="items-center font-semibold">Our Expertise</p>
